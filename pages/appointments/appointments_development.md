...
keywords: appointments development
tags: [appointments,appointments]
sidebar: appointments_sidebar
permalink: appointments_development.html
summary: "Development overview to Appointments capability"
---

## Introduction ##

The Appointments Management capability provides the ability to do cross organisation appointment booking across Organisations in a structured and coded format; it consists of the following functions:
