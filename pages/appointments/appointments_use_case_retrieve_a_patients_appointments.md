...
<br/>
<object type="image/svg+xml" data="images/appointments/RetrievePatientsApp.svg" style="max-width:90%;max-height:90%;display:block;margin: 0 auto;" alt="Date range parameters"></object>
<br/>
