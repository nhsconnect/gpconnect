...
{% include important.html content="The 'Retrieve a patient's appointments' capability was updated on 16th March 2018 with new requirements around the search parameters. These changes affect both Consumer and Provider behavior. This retrospective change was made with agreement from the providers and consumers GP Connect was aware had started developing against this version of the specification. The change simplifies the requirements for both consumers and providers so rather than implementing a breaking change in the next spec release, GP Connect decided to release this as an amendment to an old specification due to the low number of people who had started development against this version of the specification." %}
