...
<div class="alert alert-warning" role="alert">
  <i class="fa fa-warning"></i> <b>Important: Technical errata made on 16 Mar 2018</b><br/>

  <p>In agreement with stakeholders engaged in building GP Connect 1.0.0 we have made the following changes to improve and simplify two parts of the GP Connect interface, since the changes stated beneath this technical errata:</p>
