...
{% include important.html content="This release contains a change of FHIR version from DSTU2 to STU3 as the base fhir version for the GP Connect API." %}

### Core specification changes - formally GP Connect 1.0.0-rc.1 (Released: 28/11/2017)
...
### Foundations changes - formally GP Connect 1.0.0-rc.4 (Released: 28/11/2017)
...
### Appointment management changes - formally Appointment Management 1.0.0-rc.3 (Released: 28/11/2017)
