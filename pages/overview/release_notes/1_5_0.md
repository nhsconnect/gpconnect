...
- updated bundle population diagram to include `includeNotGiven` part parameter
...
#### Merge seperate Access Document 1.0.1 specification into this GP Connect API 1.5.0 specification ####
...
- An Access Document capability has been created under this specification and the content of the previously seperate Access Document has been merged in.
