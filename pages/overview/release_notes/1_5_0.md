...
- Reword the page to make clear it is a capability statement describing the Access Document capability only
...
- Diagrams changed to reflect filing comments are referenced from the diagnostic report and not the other direction
...
- Guidance for the filing comments observation profile has been updated to reference population of elements where the comments relate to a single test result
...
- [Investigations specimen](accessrecord_structured_development_specimen)
...
- [Structural resources list page](accessrecord_structured_development_list.html)
...
Minor changes to the text to clarify that free text recorded in consultation use the observation resource as defined under uncategorised data, but free text which is not associated with a clinical code must only be returned in the context of a consultation (and problem when linking a consultation topic items) and not in response to only an uncategorised data request.
...
**Tickets:** &nbsp; [#1141](https://github.com/nhsconnect/gpconnect/issues/1141)
...
**Tickets:** &nbsp; [#1138](https://github.com/nhsconnect/gpconnect/issues/1138)
...
**Tickets:** &nbsp; [#1139](https://github.com/nhsconnect/gpconnect/issues/1139)
...
**Tickets:** &nbsp; [#1147](https://github.com/nhsconnect/gpconnect/issues/1147)
...
### Updated links to Observation profile to use correct version
...
### Correction to coding system in FHIR error examples

**Tickets:** [#1181](https://github.com/nhsconnect/gpconnect/issues/1181)
...
- Updated the coding system in FHIR error examples
...
### Correction to data type for practitioner.role

**Tickets:** [#1179](https://github.com/nhsconnect/gpconnect/issues/1179)
...
- Updated the data type for practitioner.role to CodeableConcept
