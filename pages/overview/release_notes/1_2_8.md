...
- Organisation configuration screen(s) for service ID filtering, allowing:
  - a list of services (service IDs and names) to be set up for an organisation
  - linking of appointment sessions/rotas and services
  - an organisation to switch on service ID filtering once they have set their list up
