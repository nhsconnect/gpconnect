...
- The problems section of the record was able to be filtered by the significance of the problem via the
  ...
  a description of how to handle the situation should requests be made including the parameter. The existing forward
  compatibility section has been linked to.
...
- The description of the `OperationDefinition` for the retrieve a patient's record API has been updated to ensure it
  ...
  handle the situation, should requests be made including the parameter, has been described and existing forward
  compatibility section has been linked to.
