...
#### Migrate patient document interaction is mandatory for all GP system suppliers
...
- The migrate patient's document interaction had previously been a **MAY** implement requirement. It is now a **MUST** implement requirement and applies to all GP system suppliers
...
#### Migrate patient record interaction is mandatory for all GP system suppliers
...
- The migrate patient's structured record interaction had previously been a **MAY** implement requirement. It is now a **MUST** implement requirement and applies to all GP system suppliers
