...
redirect_to: https://simplifier.net/guide/gp-connect-access-record-structured/Home/Introduction/Release-notes?version=current#1.6.2
keywords: GP Connect, release notes
tags: [release]
sidebar: overview_sidebar
permalink: overview_release_notes_1_6_2.html
summary: "GP Connect API 1.6.2-beta released on XX June 2025"
toc: true
---
...
- [Test groups, test reports and test reports may have many filing comments](#test-groups-test-reports-and-test-results-may-have-many-filing-comments)
- [Profiles link through to Simplifier](#profiles-link-through-the-simplifier)
...
- [List](accessrecord_structured_development_list)
...
- Links to profiles have been updated to link to the profile hosted on
  Simplifier within the
  [GP Connect Data Model | FHIR STU3 Representation](https://simplifier.net/guide/gpconnect-data-model/Home/FHIR-Assets/Profiles?version=current)

**Pages changed:**

Profiles now linking directly to Simplifier:

- [Access Documents bundle guidance](access_documents_development_bundle)
- [AllergyIntolerance](accessrecord_structured_development_allergyintolerance)
- [DiagnosticReport](accessrecord_structured_development_diagnosticReport)
- [Diary entry](accessrecord_structured_development_diaryentry)
- [Encounter](accessrecord_structured_development_encounter)
- [DocumentReference](access_documents_development_documentreference)
- [Immunization](accessrecord_structured_development_immunization)
- [Medication](accessrecord_structured_development_medication)
- [MedicationRequest](accessrecord_structured_development_medicationrequest)
- [MedicationStatement](accessrecord_structured_development_medicationstatement)
- [Observation (blood pressure)](accessrecord_structured_development_observation_bloodPressure)
- [Observation (filing comments)](accessrecord_structured_development_observation_filingComments)
...
- [Access Documents use case - find a patient](access_documents_use_case_find_a_patient)
- [Access Record Structured](accessrecord_structured_development_version_compatibility)
- [Access Record Structured use case - migrate a patient's record](accessrecord_structured_development_migrate_patient_record)
- [Access Record Structured use case - retrieve a patient's record](accessrecord_structured_development_retrieve_patient_record)
- [Appointments](appointments)
- [Appointments data library](datalibraryappointment)
- [Appointments use case - amend an appointment](appointments_use_case_amend_an_appointment)
- [Appointments use case - book an appointment](appointments_use_case_book_an_appointment)
- [Appointments use case - cancel an appointment](appointments_use_case_cancel_an_appointment)
- [Appointments use case - retrieve appointments](appointments_use_case_retrieve_a_patients_appointments)
- [Appointments use case - search for free slots](appointments_use_case_search_for_free_slots)
- [Error handling guidance](development_fhir_error_handling_guidance)
- [Foundations data library](datalibraryfoundation)
- [Foundations design](foundations_design)
- [Foundations use case - find a patient](foundations_use_case_find_a_patient)
- [Foundations use case - find a practitioner](foundations_use_case_find_a_practitioner)
- [Foundations use case - find an organisation](foundations_use_case_find_an_organisation)
- [Foundations use case - read a location](foundations_use_case_read_a_location)
- [Foundations use case - read a patient](foundations_use_case_read_a_patient)
- [Foundations use case - read a practitioner](foundations_use_case_read_a_practitioner)
- [Foundations use case - read an organisation](foundations_use_case_read_an_organisation)
- [Foundations use case - register a patient](foundations_use_case_register_a_patient)
...
- [Find a patient](access_documents_use_case_find_a_patient)
- [Retrieve a document](access_documents_development_retrieve_patient_documents)
...
- [List of FHIR&reg; resource profiles used in the Access Record Structured capability pack](accessrecord_structured_development_resources_overview)
...
- The 'Problems' section of the record was able to be filtered by the significance of the problem via the
  `filterSignificance` part parameter. The functionality is not required and has been removed, leaving only a problem's
  status as a filter for problems. The description of the `OperationDefinition` has been updated accordingly along with
  a description of how to handle the situation should requests be made including the parameter. A link to the existing
  forward compatibility section has been included
- Updated requirements catalogue to remove significance filter

**Pages changed:**

- [API version compatibility](accessrecord_structured_development_version_compatibility)
- [Problems guidance](accessrecord_structured_development_problems_guidance)
- [Requirements catalogue](pages/accessrecord_structured/GP%20Connect%20Req%20Cat%20-%20Access%20Record%20Structured%20Data%20v2.4.xlsx)
- [Retrieve a patient's record in structured format](accessrecord_structured_development_retrieve_patient_record)
...
- [Configuration for supported clinical areas](accessrecord_structured_development_clinical_area_config)
...
- [Allergies guidance](accessrecord_structured_development_allergies_guidance)
...
- The description of the `OperationDefinition` for the retrieve a patient's record API has been updated to ensure it
  aligns with the profile definition. The `filterPrescriptionType` part parameter isn't supported by the API but does
  exist on the profile. As a result, it has been added to the description and made clear it isn't supported. How to
  handle the situation, should requests be made including the parameter, has been described and a link to the existing
  forward compatibility section has been included
