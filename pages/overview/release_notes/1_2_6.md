...
- Leave the existing 'combined' capability statement in the Foundations capability as-is for the moment to allow a phased transition for Access Record Structured consumer systems.  This will also continue to remain as-is for Appointment Management consumers.
