...
- [Register a patient](foundations_use_case_register_a_patient.html)
  ...
  - Changed the requiremnets for a consumer to pass in telecom and address details to a consumer may pass in only temporary telecom and address details in the request.
