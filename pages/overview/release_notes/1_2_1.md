...
<div class="alert alert-info" role="information">
  <b>Appointments requirements clarifications made on 27 Sep 2018</b><br/>
  ...
  <ul>
    <li><a href="appointments_use_case_book_an_appointment.html">Book an appointment</a>
      <ul>
        <li>bookingOrganisation.identifier element shall carry an ODS code</li>
        <li>bookingOrganisation.type shall not be populated if an organization type was not passed to the searchFilter</li>
      </ul>
    </li>
    <li>
      ...
      <ul>
        <li>Include the If-Match header in the request headers list</li>
      </ul>
    </li>
