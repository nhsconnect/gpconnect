...
### Clarify fullUrl guidance for Bundle resources ###
**Tickets**:&nbsp; [#605](https://github.com/nhsconnect/gpconnect/issues/605)

**Affects:**&nbsp; Access Record Structured

**Description:**
- Clarify how entry.fullUrl should be populated in Bundles.

**Pages changed**
- [Bundle resource page](accessrecord_structured_development_bundle.html)

---

### Correct issues in the examples ###

**Tickets**:&nbsp; [#633](https://github.com/nhsconnect/gpconnect/issues/633)

**Affects:**&nbsp; Access Record Structured

**Description:**

- Some issues with the Bundle examples have been fixed
