...
- Clarify that Appointment, Schedule and Slot date/time elements to be populated in local time in the format `yyyy-mm-ddThh:mm:ss+hh:mm`, using timezone offset `+00:00` for UTC and `+01:00` for BST
