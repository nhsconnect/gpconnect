...
- Clarify Search for free slots start and end parameters may be dates in the format `yyyy-mm-dd`, or date and time in the format in the format `yyyy-mm-ddThh:mm:ss+hh:mm`, using the appropriate timezone offset
