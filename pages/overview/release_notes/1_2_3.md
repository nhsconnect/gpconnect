...
### Tidy and reformat Search for free slots page to make easier to read *(cosmetic)* ###

**Tickets**:&nbsp; [#642](https://github.com/nhsconnect/gpconnect/issues/642)

**Affects:**&nbsp; Appointment Management

**Description:**

- Re-ordered sections in line with other API use case pages
- Added mandatory/required/optional columns to parameter tables
- Improve wording in search filter section
- Fix examples to include properly include search filters
