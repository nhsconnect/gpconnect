...
### Added guidance on how multiple warning codes should be populated ###

**Affects** Access Record Structured

**Description**
- Guidance has been provided on how multiple warning codes should be provided in the List resource.
...
### Remove data awaiting filing warning code ###

**Affects** Access Record Structured

**Description:**
- The data awaiting filing warning code has been removed as it is no longer a valid use case.
