...
summary: "GP Connect API 0.7.2-rc released on 29th of March 2019"
toc: false
---
...
The GP Connect 0.7.2-rc release contains SDS changes that affects all consumers. The information on the JWT page has been rewritten to be more informative, and to address the JWT timing validation issue.
