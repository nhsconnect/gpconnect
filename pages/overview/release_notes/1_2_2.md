...
**Tickets**:&nbsp; [#558](https://github.com/nhsconnect/gpconnect/issues/558)

**Affects:**&nbsp; Foundations

**Description**:

- Add requirement to NOT populate the following Patient resource elements:
  - ethnicCategory
...
- Add requirement to NOT populate the following Practitioner resource elements:
  - telecom
  - address
  - birthDate
  - photo
...
- Add requirement to NOT populate the following element on Schedule, Slot and Appointment resources:
  - specialty
...
### Strengthen element population requirements for Location and Organization

**Tickets**:&nbsp; [#566](https://github.com/nhsconnect/gpconnect/issues/566) [#563](https://github.com/nhsconnect/gpconnect/issues/563) [#560](https://github.com/nhsconnect/gpconnect/issues/560)

**Affects:**&nbsp; Foundations, Appointment Management

**Description:**

- Add explicit requirements to populate:
  - Organization.name
...
- Remove requirement to populate:

  - ODS 'site' code in Location.identifier
