...
### Add ContactPoint data type population requirements
...
- Add explicit requirements for the population of ContactPoint data type in line with expectations set through examples
...
- Add explicit requirement to populate Patient.managingOrganization (Note: this is not the same as the patient's registered practice)
...
- Document known issue relating to returned Organization resource in Search for free slots Bundle.
