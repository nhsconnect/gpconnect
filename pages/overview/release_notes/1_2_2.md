...
<div class="alert alert-warning" role="alert">
  <i class="fa fa-warning"></i> <b>Important: Technical update made on 15 Jan 2018</b><br/>

  <p>In agreement with stakeholders engaged in building GP Connect 1.2.2 Access Record Structured the following changes were made to clarify and simplify the use of Bundle and List for Access Record Structured, since the original release on the 24 Oct 2018:</p>

  <ul>
    <li><a href="accessrecord_structured_development_list.html#list-elements-not-in-use">Access Record Structured - List.id</a> - Move element to 'not in use' list, and update examples in line with change</li>

    <li><a href="accessrecord_structured_development_bundle.html#bundle-elements-not-in-use">Access Record Structured - Bundle.id</a> - Add element to 'not in use' list, and update examples in line with change</li>
  </ul>
</div>
