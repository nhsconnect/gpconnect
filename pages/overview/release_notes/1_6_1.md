...
#### Migrate patient document interaction is optional for incumbents and required for NMEs
...
- Added note to state the migrate patient's document interaction **MAY** be implemented by incumbents and **MUST** be implemented by NMEs
