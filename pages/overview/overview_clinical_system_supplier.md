...
As a GP clinical system supplier or *provider*, such as EMIS Health, INPS Vision, Microtest Health or TPP, you can use GP Connect to develop a way of allowing other systems to access GP data on your system for direct patient care.
