...
```json
{
  ...
  "description": "This server implements the GP Connect API version 1.2.5",
  ...
  "profile": [
      ...
      { "reference": "https://fhir.nhs.uk/STU3/StructureDefinition/CareConnect-GPC-List-1/_history/1.1" },
