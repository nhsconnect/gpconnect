...
- Providing system URL format (see below)
...
### Providing system URL format ###

[Providing system URLs](development_general_api_guidance.html#fhir-api-versioning) contain the major version number of the specification.
