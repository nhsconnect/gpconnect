...
The payload request body comprises a `Parameters` resource, conforming to the [GPConnect-GetStructuredRecord-Operation-1](https://simplifier.net/guide/gpconnect-data-model/Home/FHIR-Assets/All-assets/OperationDefinitions/OperationDefintion--GPConnect-GetStructuredRecord-Operation-1?version=current) `OperationDefinition` profile.
...
| -----------------                                                                                                                                                                                                                                                                                                              | -------------------------                                                                        |
| The `Parameters` resource passed does not conform to that specified in the [GPConnect-GetStructuredRecord-Operation-1](https://simplifier.net/guide/gpconnect-data-model/Home/FHIR-Assets/All-assets/OperationDefinitions/OperationDefintion--GPConnect-GetStructuredRecord-Operation-1?version=current) `OperationDefinition` | [`INVALID_RESOURCE`](development_fhir_error_handling_guidance.html#resource-validation-errors)   |
