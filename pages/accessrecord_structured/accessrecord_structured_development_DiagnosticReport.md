...
- the lab report ID, if it is scoped to the NHS PMIP Report Numbers CodeSystem (from [HL7 UK Issued OIDs](https://www.hl7.org.uk/standards/object-identifiers-oids/hl7-uk-issued-oids/)) and it could be used to assist in matching lab reports. In this case `identifier.system` would be `urn:oid:2.16.840.1.113883.2.1.4.5.5`
