...
redirect_to: https://simplifier.net/guide/gpconnect-data-model/Home/FHIR-Assets/All-assets/Profiles/Profile--CareConnect-GPC-MedicationStatement-1?version=current
...
{% include tip.html content="You'll find it helpful to read it in conjunction with the underlying [MedicationStatement profile definition](https://simplifier.net/guide/gpconnect-data-model/Home/FHIR-Assets/All-assets/Profiles/Profile--CareConnect-GPC-MedicationStatement-1?version=current)." %}
...
For provider systems that support fully structured dosage instructions a complete `Dosage` structure should be populated as per [guidance](accessrecord_structured_development_medication_guidance.html#medication-and-medical-device-interoperability).
