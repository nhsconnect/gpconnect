...
The SDS queries in GP Connect API 0.5.1 and prior versions do not support this configuration, hence existing consumer systems **MUST** update their queries to this version of the specification." %}
