...
{% include important.html content="**Why have SDS queries changed in GP Connect API 0.5.2?**<br/>
...
The SDS queries in GP Connect API 0.5.1 and prior versions do not support this configuration, hence existing consumer systems **MUST** update their queries to to this version of the specification." %}
