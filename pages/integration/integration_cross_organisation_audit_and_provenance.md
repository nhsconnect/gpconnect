...
Provider systems **MUST** ensure that access to confidential data, including patient or clinical data, through the API meet, as a minimum, the same requirements for information governance (IG), authentication and authorisation, and auditing as that of the host system the API exposes.
