...
|-------|-------------|------|
| `patient/*.read` | Patient record read request | - [Find a patient](foundations_use_case_find_a_patient.html)<br/> - [Search for a patient's documents](accessrecord_documents_development_search_patient_documents.html)<br/> - [Retrieve a patient's documents](accessrecord_documents_development_retrieve_patient_documents.html)<br/>
| `organization/*.read` | Other read request | - [Get the capability statement](foundations_use_case_get_the_fhir_capability_statement.html)<br/>|
