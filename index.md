...
<p>GP Connect is developing standardised specifications for application programming interfaces ({%include tooltip.html type="API"%}s) to be used by any system for the sharing of data, so that clinicians in different care settings can:</p>
